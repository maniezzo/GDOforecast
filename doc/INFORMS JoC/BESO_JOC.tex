...
\allowdisplaybreaks[4]  % Scale 0-4; higher = more breaks allowed (default 0 = none)
\begin{align}
...
This section reports on the sensitivity of the solution to variations in the instance coefficients. Appendix B of the Electronic Companion provides an initial study of the fitness landscape for the split-assignment problem, using a set of artificial benchmark instances.
