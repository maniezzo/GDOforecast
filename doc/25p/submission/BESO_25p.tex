...
\author[Running Author]{Livio Fenga\affmark{a} and Vittorio Maniezzo\affmark{b,$\ast$}}

\affil{\affmark{a}Center for Simulation, Analytics and Modelling, University of Exeter, EX4 4PU Exeter, UK}
\affil{\affmark{b}Department of Computer Science, University of Bologna, 40100 Bologna, Italy}
\email{L.Fenga@exeter.ac.uk [L.Fenga]; vittorio.maniezzo@unibo.it [V.Maniezzo]}

%Author's notes/correspondence etc.
\thanks{\affmark{$\ast$}Author to whom all correspondence should be addressed (e-mail: vittorio.maniezzo@unibo.it).}
...
% Appendix
\vspace*{-10pt}
\appsection{Appendix A: Cost function values} \label{app:errcost}
...
\appsection{Appendix B: Extended deterministic benchmark set} \label{app:artificial}
